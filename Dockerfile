...
# docker build -t doryengine/dorycli:v1.5.1-alpine .
# docker push doryengine/dorycli:v1.5.1-alpine

# 创建外部目录保存.dorycli/config.yaml
# mkdir -p .dorycli && sudo chown -R 1000:1000 .dorycli
# docker run -ti --rm -v $PWD/.dorycli:/home/dory/.dorycli doryengine/dorycli:v1.5.1-alpine bash
